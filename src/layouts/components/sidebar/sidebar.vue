      ...
      <nav class="main-menu-container nav nav-pills flex-column sub-open">
        ...
        <ul class="main-menu">
          ...
          >
            ...
            <template
              v-if="mainmenuItem?.type === 'link' && can(mainmenuItem.action, mainmenuItem.subject)"
            >
              <router-link
            ...
            <template v-if="mainmenuItem?.type === 'sub' && hasVisibleDeepChild(mainmenuItem)">
              <RecursiveMenu
        ...
        <ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
          ...
          <!-- Start::slide -->
          <li class="slide">
            <router-link to="#!" class="side-menu__item">
...
<script setup>
import staticMenuData from '@/navigation/index.js'
...
watchEffect(() => {
  let currentPath = router.currentRoute.value.path.endsWith('/')
    ? router.currentRoute.value.path.slice(0, -1)
