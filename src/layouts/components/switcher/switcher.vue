...
const MENU = reactive(navigation)
          ...
          <div>
            ...
            <div class="theme-colors">
              ...
              <div class="d-flex flex-wrap align-items-center switcher-style">
                <div class="form-check switch-select me-3">
                  <input
                    @click="themeBackgroundFn('0,8,52', '14,22,66')"
                ...
                <div class="form-check switch-select me-3">
                  <input
                    @click="themeBackgroundFn('58, 0, 109', '72 ,14, 123')"
                ...
                <div class="form-check switch-select me-3">
                  <input
                    @click="themeBackgroundFn('0 ,59, 70', '14, 73, 84')"
                ...
                <div class="form-check switch-select me-3">
                  <input
                    @click="themeBackgroundFn('65, 0, 0', '79 ,14, 14')"
                ...
                <div class="form-check switch-select me-3">
                  <input
                    @click="themeBackgroundFn('1 ,77, 46', '15 ,91, 60')"
